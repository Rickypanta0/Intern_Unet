...
def get_model_paper(input_shape=(256, 256, 3)):
    ...
    l = [32,64,128,256,512]
    # Encoder
    c1 = layers.Conv2D(l[0], 3, kernel_initializer="he_normal", padding="same")(inputs)
    c1 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c1)
    c1 = layers.Activation("relu")(c1)
    c1 = layers.Dropout(0.1)(c1)
    c1 = layers.Conv2D(l[0], 3, kernel_initializer="he_normal", padding="same")(c1)
    c1 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c1)
    c1 = layers.Activation("relu")(c1)
    p1 = layers.MaxPooling2D(2)(c1)

    c2 = layers.Conv2D(l[1], 3, kernel_initializer="he_normal", padding="same")(p1)
    c2 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c2)
    c2 = layers.Activation("relu")(c2)
    c2 = layers.Dropout(0.1)(c2)
    c2 = layers.Conv2D(l[1], 3, kernel_initializer="he_normal", padding="same")(c2)
    c2 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c2)
    c2 = layers.Activation("relu")(c2)
    p2 = layers.MaxPooling2D(2)(c2)

    c3 = layers.Conv2D(l[2], 3, kernel_initializer="he_normal", padding="same")(p2)
    c3 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c3)
    c3 = layers.Activation("relu")(c3)
    c3 = layers.Dropout(0.2)(c3)
    c3 = layers.Conv2D(l[2], 3, kernel_initializer="he_normal", padding="same")(c3)
    c3 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c3)
    c3 = layers.Activation("relu")(c3)
    p3 = layers.MaxPooling2D(2)(c3)

    # Bottleneck
    c5 = layers.Conv2D(l[3], 3, kernel_initializer="he_normal", padding="same")(p3)
    c5 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c5)
    c5 = layers.Activation("relu")(c5)
    c5 = layers.Dropout(0.3)(c5)
    c5 = layers.Conv2D(l[3], 3, kernel_initializer="he_normal", padding="same")(c5)
    c5 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c5)
    c5 = layers.Activation("relu")(c5)
    p5 = layers.MaxPooling2D(2)(c5)

    c6 = layers.Conv2D(l[4], 3, kernel_initializer="he_normal", padding="same")(p5)
    c6 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c6)
    c6 = layers.Activation("relu")(c6)
    c6 = layers.Dropout(0.3)(c6)
    c6 = layers.Conv2D(l[4], 3, kernel_initializer="he_normal", padding="same")(c6)
    c6 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c6)
    c6 = layers.Activation("relu")(c6)
    ...
    c10 = layers.Conv2D(l[0], 3, kernel_initializer="he_normal", padding="same")(c10)
    c10 = layers.BatchNormalization(axis=-1, momentum=0.9, epsilon=1e-3)(c10)
    c10 = layers.Activation("relu")(c10)

    c11 = layers.Dropout(0.1)(c10)
    c11 = layers.Conv2D(l[0]//2, 3, kernel_initializer="he_normal", padding="same")(c11)
